      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.inner_container}>
            ...
            <Image  source={require('../../app/assets/logo/logo.png')} style={styles.logo_container}/>
            ...
            <View style={styles.notice_container}>
              <Text style={{color: 'black', fontSize: 17, marginTop: 20, textAlign: 'center'}}>
                You will need an access code from a Bible distribution group to continue. To find a group near you, click
                </Text>
