...
export default {
  ...
  'auth/invalid-email': 'อีเมลที่ป้อนไม่ถูกต้อง (อาจเป็นสาเหตุโดยใช้สัญลักษณ์ที่ไม่ถูกต้อง)',
  'auth/operation-not-allowed': 'บัญชีอีเมล / รหัสผ่านถูกปิดใช้งาน กรุณาติดต่อ sharebibles@faithtech.com',
  'button/add': 'เพิ่ม',
